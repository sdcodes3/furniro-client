    ...
    <>
      <div className="singleItem">
            ...
            <Col xxl={6} md={6} sm={6} className="item-FullDetails">
              ...
              <Row className="ratings" style={{ marginBottom: '1.5rem' }}>
                <div className="rating-container">
                  ...
                  <span className="rating-text" style={{ color: '#9F9F9F', fontWeight: 500 }}>
                    5 Customer Review
                  </span>
                </div>
              </Row>
        ...
        <div className="menu-title">
          <h4
            className={activeTab === 'description' ? 'selected' : ''}
          ...
          <h4
            className={activeTab === 'additional' ? 'selected' : ''}
          ...
          <h4
            className={activeTab === 'reviews' ? 'selected' : ''}
